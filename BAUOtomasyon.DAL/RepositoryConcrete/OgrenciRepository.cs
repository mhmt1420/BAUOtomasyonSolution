...
namespace BAUOtomasyon.DAL.RepositoryConcrete
{
    public class OgrenciRepository : IOgrenciRepository
    {
        ...
        public int UpdateItem(Ogrenci item)
        {
            ...
            eskiOgrenci.OgrenciIletisimleri = item.OgrenciIletisimleri;
            _etkilenenSatir = _db.SaveChanges();
            return _etkilenenSatir;
        }
        ...
        public ICollection<OgrenciIletisimDTO> OgrenciIletisim()
        {
            return (from ogrenci in _db.Ogrenci
                    join iletisim in _db.Iletisim on ogrenci.ID equals iletisim.OgrenciID
                    select new OgrenciIletisimDTO
                    {
                        Ad = ogrenci.Adi,
